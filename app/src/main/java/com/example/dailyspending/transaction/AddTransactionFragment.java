...
public class AddTransactionFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =  inflater.from(container.getContext()).inflate(R.layout.transaction_add, container, false);
        this.money = view.findViewById(R.id.transaction_add_money);
        this.note = view.findViewById(R.id.transaction_add_note);
        this.date = view.findViewById(R.id.transaction_add_date);
        this.with = view.findViewById(R.id.transaction_add_with);
        this.reminder = view.findViewById(R.id.transaction_add_remind);
        this.category = view.findViewById(R.id.transaction_add_category);
        this.cancel = view.findViewById(R.id.transaction_add_cancel);
        this.save = view.findViewById(R.id.transaction_add_save_button);
        onReport = view.findViewById(R.id.transaction_add_checkbox);
        // Get Current Date
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TransactionDao.getInstance().add(transaction);
                FragmentManager fm = getFragmentManager();
                if (fm.getBackStackEntryCount() > 0){
                    fm.popBackStack();
                }
